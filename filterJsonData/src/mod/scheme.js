const scheme = {
	...
	mi_yrzsccoddotmlacdps:
		'Your Raised Zombies spread Caustic Cloud on Death, dealing #% of their maximum Life as Chaos Damage per second',
	...
	o_mtcsmaatdmfafcsaotvldwh:
		'Modifiers to Critical Strike Multiplier also apply to Damage Multiplier for Ailments from Critical Strikes at #% of their value\n#% less Damage with Hits',
	o_odtgamoswh: '#% of Damage taken gained as Mana over # seconds when Hit',
	o_eyhwedtgrtteartoe:
		'Enemies you hit with Elemental Damage temporarily get +#% Resistance to those Elements and -#% Resistance to other Elements',
	...
	trickster_pr:
		"#% increased Recovery Rate of Life, Mana and Energy Shield if you've Killed an Enemy affected by your Damage Over Time Recently",
	...
	// ascendancy specific
	as_MORE_p_pahdutmdttatsotmdldttatptf:
		'Projectile Attack Hits deal up to #% more Damage to targets at the start of their movement, dealing less Damage to targets as the projectile travels farther',
	as_arid: 'Accuracy Rating is Doubled',
	as_tcscppaeut: '+#% to Critical Strike Chance per Poison affecting Enemy, up to +#%',
	as_ctiywgecyigutymnoec:
	...
	as_irrolmaesiykaeabydotr:
		"#% increased Recovery Rate of Life, Mana and Energy Shield if you've Killed an Enemy affected by your Damage Over Time Recently",
	as_wykaefecotegoncdaecdfs:
		'When you Kill an Enemy, for each Curse on that Enemy, gain #%\nof Non-Chaos Damage as extra Chaos Damage for # seconds',
	...
	as_oesrpsfeeyoymhkrut:
		'#% of Energy Shield Regenerated per second for each\nEnemy You or your Minions have Killed Recently, up to #%',

import { BaseIcon, OneAtomCommonPropType, OneAtomBaseIconProps } from 'one-atom';

export namespace Icon {
  export interface Props extends OneAtomCommonPropType, Omit<OneAtomBaseIconProps, 'viewBox'> {}

  interface PropsEva extends Props {}

  export const logo_text: FC<Props> = function icon_logo_text({ ...rest }) {
    return (
      <BaseIcon viewBox="0 0 1024.41 416.95" {...rest}>
  ...
  export const arrow: FC<Props> = function icon_arrow({ ...rest }) {
    return (
      <BaseIcon {...rest} viewBox="0 0 335 335">

function decode(str: string) {
	...
	const nodes = [];
	const version = decoded.charCodeAt(0) * 16777216 + decoded.charCodeAt(1) * 65536 + decoded.charCodeAt(2) * 256 + decoded.charCodeAt(3);

	if (version > 4) {
		throw new Error('Invalid Skill Tree version');
	}
